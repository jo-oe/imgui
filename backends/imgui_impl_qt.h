...
//IMGUI_IMPL_API bool     ImGui_ImplQt_InitForOpenGL(QGLWindow* _window);
IMGUI_IMPL_API bool     ImGui_ImplQt_InitForVulkan(QVulkanWindow* _window, QVulkanWindowRenderer *_renderer);
...
IMGUI_IMPL_API bool     ImGui_ImplQt_ProcessEvent(const QEvent* _event);
